...
server.registerResource({
    ...
    name: "NAP Resource",
    description: "Access any NAP narrative resource by its nap:// URI. " +
...
async function runStdio() {
    ...
    console.error(`[nap-mcp-server] Running via stdio → ${CONFIG.napServerUrl}`);
}
async function runHTTP() {
    ...
    app.listen(port, () => {
        console.error(`[nap-mcp-server] Running via HTTP on :${port}/mcp → ${CONFIG.napServerUrl}`);
    });
}
