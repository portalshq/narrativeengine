...
Fragment queries are supported via the URI: nap resolve nap://toystory/character/lukeskywalker#references.appears_in
...
|---|---|---|
| uri | NAP URI. e.g., "nap://toystory/character/lukeskywalker" | Yes |
