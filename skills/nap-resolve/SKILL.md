...
1. Create the entity on `main`.
2. Report the exact URI.
3. Establish active task context: URI, repository, entity type, entity ID, and default revision branch.
...
1. Resolve the entity explicitly from the relevant branch.
...
Resolve from `main` for canonical state.
