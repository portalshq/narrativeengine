...
if (!global[LAB_TOKEN]) {
  global[LAB_TOKEN] = process.env.LAB_SECRET || `lab_${randomUUID()}`;
}
...
export { GLOBAL_KEY, InMemoryNarrativeProvider, LAB_TOKEN, NarrativeEngine, SESSION_SECRET, configureLabEngine, getActiveEngine, normalizeScore, validateProviderShape };
