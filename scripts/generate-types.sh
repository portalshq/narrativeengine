...
cargo run --quiet --manifest-path "$ROOT_DIR/Cargo.toml" --package narrativeengine-codegen -- --language python --out "$ROOT_DIR/python/narrativeengine/narrativeengine/models.py"
